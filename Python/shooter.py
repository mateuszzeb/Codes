...
class Player:
    objects = []
    def __init__(self, x, y, d, color, keys=[K_a, K_d, K_w, K_SPACE]):
        self.color = color
        self.hidden = False
        self.radius = 40
        self.keys = keys
...
Player(40, 40, 225, [0, 255, 0], keys=[K_LEFT, K_RIGHT, K_UP, K_RETURN])
Player(200, 200, 225, [0, 255, 0], keys=[K_LEFT, K_RIGHT, K_UP, K_RETURN])
Player(200, 40, 225, [0, 255, 0], keys=[K_LEFT, K_RIGHT, K_UP, K_RETURN])
Player(screen.get_width() - 40,screen.get_height() -200, 45, [255, 0, 0])
Player(screen.get_width() - 40,screen.get_height() -40, 45, [255, 0, 0])
Player(screen.get_width() - 200,screen.get_height() -200, 45, [255, 0, 0])
